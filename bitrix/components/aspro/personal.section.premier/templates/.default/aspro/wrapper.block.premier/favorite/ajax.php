...
$arItems = TSolution\Itemaction\Favorite::getItems();
?>
<div class="personal__block personal__block--favorite-products">
	<?if ($arItems):?>
		...
		$offersID = TSolution\Itemaction\Favorite::getOffersIDFromItems($arItems);
		...
		<?$this->SetViewTarget("more_text_title");?>
			<div class="js_clear_favorits color-theme-hover font_13 secondary-color"><?=Bitrix\Main\Localization\Loc::getMessage('CLEAR_FAVORITS')?></div>
		<?$this->EndViewTarget();?>
		<?
		if ($bAjax) {
