...
TSolution\CacheableUrl::addParams([
    'q',			// query to search
    'searchingImage',	// query to search by img
...
$APPLICATION->IncludeComponent(
    ...
    array_merge(
        ...
        [
            ...
            'SHOW_LANDINGS' => ($arParams['SHOW_LANDINGS_SEARCH'] != 'N' ? 'Y' : 'N'),
            'LANDING_TITLE' => $arParams['LANDING_SEARCH_TITLE'],
            'LANDING_SECTION_COUNT' => $arParams['LANDING_SEARCH_COUNT'],
            'LANDING_SEARCH_COUNT_VISIBLE' => $arParams['LANDING_SEARCH_COUNT_VISIBLE'],
            ...
            'SHOW_SORT_RANK_BUTTON' => ($arParams['SHOW_SORT_RANK_BUTTON'] != 'N' ? 'Y' : 'N'),
            'USE_SEARCH_RESULT_ORDER' => $arParams['SEARCH_USE_SEARCH_RESULT_ORDER'],
            'CATALOG_TEMPLATE_PATH' => $this->__folder,
