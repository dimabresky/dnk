...
if($arParams['SECTION_TYPE_VIEW'] === 'FROM_MODULE'){
	...
	$highElement = $blockTemplateOptions['ADDITIONAL_OPTIONS']['SECTIONS_HIGH_ELEMENT_MOBILE']['VALUE'];
	$elementsInRow = $blockTemplateOptions['ADDITIONAL_OPTIONS']['SECTIONS_ELEMENTS_COUNT_MOBILE']['VALUE'];
}
else{
	$highElement = $arParams['SECTION_HIGH_ELEMENT'];
