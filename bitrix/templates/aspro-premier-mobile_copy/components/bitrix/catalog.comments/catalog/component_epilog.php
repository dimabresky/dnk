...
$arExtensions = ['catalog_comments', 'vote', 'popover', 'smart_filter.ui', 'chip', 'dropdown_select'];
if ($arParams['NO_USE_IMAGE'] == 'N') {
    $arExtensions[] = 'drop';
    $arExtensions[] = 'ui-card';
    $arExtensions[] = 'ui-card.ratio';
}
TSolution\Extensions::init($arExtensions);
TSolution\ExtensionsMobile::init(['filter', 'scrollbar_filter', 'popover.dropdown']);
