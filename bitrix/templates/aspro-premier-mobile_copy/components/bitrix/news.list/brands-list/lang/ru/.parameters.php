...
$MESS['TITLE_DEFAULT'] = 'Бренды';
$MESS['TITLE_BLOCK_NAME'] = 'Заголовок блока';
$MESS['BLOCK_NAME'] = 'Бренды';
$MESS['ALL_URL_NAME'] = 'Ссылка на все бренды';
$MESS['TITLE_BLOCK_ALL_NAME'] = 'Заголовок на все бренды';
$MESS['T_SHOW_PREVIEW_TEXT'] = 'Отображать текст под заголовком';
$MESS['T_OVER_TITLE_TEXT'] = 'Текст над заголовком';
$MESS['V_FROM_THEME'] = 'Из настроек решения';
$MESS['T_BORDER'] = 'Обводка';
$MESS['T_BORDER_YES'] = 'С обводкой';
$MESS['T_BORDER_NOT'] = 'Без обводки';
$MESS['T_SLIDER'] = 'Карусель';
$MESS['T_MAXWIDTH_WRAP'] = 'Ограничить блок по контенту (maxwidth)';
$MESS['T_BACKGROUND'] = 'Фон';
$MESS['T_BACKGROUND_YES'] = 'С фоном';
$MESS['T_BACKGROUND_NOT'] = 'Без фона';
