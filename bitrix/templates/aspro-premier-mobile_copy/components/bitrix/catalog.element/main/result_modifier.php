    ...
    if ($bShowSKU) {
        ...
        if (!empty($arSKU) && is_array($arSKU)) {
            ...
            if ($arParams['SKU_IBLOCK_ID'] && $arParams['SKU_TREE_PROPS']) {
                ...
                $arResult['SKU_CONFIG']['EXTERNAL_ORDER_BUTTON'] = 'Y';
...
$arResult['INCLUDE_FOLDER_PATH'] = rtrim(($arParams["SEF_FOLDER"] != SITE_DIR ? $arParams["SEF_FOLDER"] : dirname($_SERVER['REAL_FILE_PATH'])), '/');
