        ...
        <div class="form">
            ...
            <?else:?>
                <form id="registraion-page-form" method="post" action="<?=POST_FORM_ACTION_URI;?>" name="regform" enctype="multipart/form-data" >
                    ...
                    $dnkRegisterAutoPassword = \Bitrix\Main\Security\Random::getStringByCharsets(
                        16,
                    ...
                    <div class="form-body">
                        <?foreach ($arFields as $FIELD):?>
                            ...
                            if ($FIELD === 'PASSWORD' || $FIELD === 'CONFIRM_PASSWORD') {
                                ?>
                                <input type="hidden" id="input_<?=$FIELD;?>" name="REGISTER[<?=$FIELD;?>]" value="<?=htmlspecialcharsbx($dnkRegisterAutoPassword);?>" autocomplete="new-password" />
                                <?php
                                continue;
                            }
