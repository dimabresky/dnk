...
foreach($arItems as $arItem){
    if($arItem['PROPERTY_MAP_VALUE']){
        ...
        foreach ($arItem['PROPERTY_EMAIL_VALUE'] as $email) {
            $emails .= '<a class="dark_link" href="mailto:' .$email. '">' .$email . '</a>';
        }
        ...
        foreach ($arItem['PROPERTY_METRO_VALUE'] as $metro) {
            $metrolist .= '<dispanv class="metro"><i></i>'. $metro . '</span>';
        }
        ...
        $popupOptions = [
            ...
            'PARAMS' => [
                'TITLE' => '',
                'BTN_CLASS' => 'btn btn-secondary-black',
            ],
            'SHOW_QUESTION_BTN' => 'Y',
            'SHOW_SOCIAL' => 'N',
            'SHOW_CLOSE' => 'N',
        ...
        if ($arItem['PROPERTY_SCHEDULE_VALUE']['TYPE'] === 'HTML') {
            $arOptions['HTML'] = TSolution\Functions::getItemMapHtml($popupOptions);
        } else {
            $arOptions['TEXT'] = TSolution\Functions::getItemMapHtml($popupOptions);
        }


        $arPlacemarks[] = $arOptions;
