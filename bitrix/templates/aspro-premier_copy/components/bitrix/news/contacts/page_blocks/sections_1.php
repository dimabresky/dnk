...
<div class="contacts-v1 contacts-detail" itemscope itemtype="http://schema.org/LocalBusiness">
	...
	<div class="grid-list grid-list--items grid-list--items-4-from-1200 grid-list--items-3-from-992 grid-list--items-2-from-601 mt mt--12">
		<div class="contacts-detail__item grid-list__item flexbox outer-rounded-x grey-bg p p--20">
		...
		<?if($bUseFeedback):?>
			<button type="button" class="contacts-detail__item text-align-left grid-list__item flexbox outer-rounded-x bordered p p--20 shadow-hovered shadow-no-border-hovered white-bg pointer stroke-grey-hover" data-event="jqm" data-param-id="<?=TSolution::getFormID("aspro_".TSolution::solutionName."_question");?>" data-name="question">
				<div class="font_13 secondary-color flex-1"><?=Loc::getMessage('T_CONTACTS_QUESTION1');?></div>
				<div class="flexbox flexbox--direction-row flexbox--align-center flexbox--justify-between gap gap--12 mt mt--auto pt pt--40 width-100 text-align-left flex-grow-0">
