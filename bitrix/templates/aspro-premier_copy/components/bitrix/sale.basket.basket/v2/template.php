...
Main\UI\Extension::load('ui.fonts.ruble');
...
if ($arParams['USE_GIFTS'] === 'Y') {
    ...
    $giftParameters = [
        ...
        'HIDE_NOT_AVAILABLE' => (Main\Config\Option::get(Solution::moduleID, 'HIDE_NOT_AVAILABLE', 'N') == 'Y') ? 'Y' : 'N',

        'PRODUCT_ROW_VARIANTS' => '',
        'PAGE_ELEMENT_COUNT' => 0,
        'DEFERRED_PRODUCT_ROW_VARIANTS' => Main\Web\Json::encode(
...
$backCatalogText = '<span class="line-block line-block--gap line-block--gap-12"><span class="icon-block">'.TSolution::showSpriteIconSvg(SITE_TEMPLATE_PATH.'/images/svg/arrows.svg#left-small', 'remove icon-block__icon icon-block__icon--sm stroke-dark-light', ['WIDTH' => 4, 'HEIGHT' => 8]).'</span>'.Loc::getMessage('SBB_BACK_CATALOG_TITLE').'</span>';
$APPLICATION->AddViewContent('cowl_buttons', '<div class="basket-back font_12"><a href="'.TSolution::GetFrontParametrValue('CATALOG_PAGE_URL').'" class="basket-back__link no-decoration secondary-to-title-hover flexbox--inline">'.$backCatalogText.'</a></div>');
            ...
            <div class="basket-items-list-outer">
                <div class="basket-items-list-wrapper basket-items-list-wrapper-height-fixed basket-items-list-wrapper-light<?= $displayModeClass;?>" id="basket-items-list-wrapper">
                    <div class="basket-items-list-header" data-entity="basket-items-list-header">
                        <div class="basket-items-list-header-filter no-clear-button">
                            <a href="javascript:void(0)" class="basket-items-list-header-filter-item active chip bg-theme-active" data-entity="basket-items-count" data-filter="all" style="display: none;"></a>
                            <a href="javascript:void(0)" class="basket-items-list-header-filter-item chip bg-theme-active" data-entity="basket-items-count" data-filter="similar" style="display: none;"></a>
                            <a href="javascript:void(0)" class="basket-items-list-header-filter-item chip bg-theme-active" data-entity="basket-items-count" data-filter="warning" style="display: none;"></a>
                            <a href="javascript:void(0)" class="basket-items-list-header-filter-item chip bg-theme-active" data-entity="basket-items-count" data-filter="delayed" style="display: none;"></a>
                            <a href="javascript:void(0)" class="basket-items-list-header-filter-item chip bg-theme-active" data-entity="basket-items-count" data-filter="not-available" style="display: none;"></a>
                        </div>
                    </div>
                    <div class="basket-items-list-container bordered outer-rounded-x" id="basket-items-list-container">
                        ...
                        <div class="basket-items-list" id="basket-item-list">
                            ...
                            <table class="basket-items-list-table height-100" id="basket-item-table"></table>
                        </div>
                    </div>
                </div>
            </div>
