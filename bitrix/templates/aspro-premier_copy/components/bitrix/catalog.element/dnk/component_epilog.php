...
TSolution\Template\Page::addDetailHeaderFixedStub();
...
<?if (!empty($templateData['OFFER_INFO'])) {
    TSolution\Product\MetaInfo::getInstance()->collect($templateData['OFFER_INFO']);
}?>
