...
<div class="catalog-detail js-popup-block">
	<?$ElementID = $APPLICATION->IncludeComponent(
	    ...
	    [
	        ...
	        'DETAIL_BLOCKS_ORDER' => ($arParams['DETAIL_BLOCKS_ORDER'] ? $arParams['DETAIL_BLOCKS_ORDER'] : 'complect,kit,sku,buy_services,tabs,expandables,associated,big_gallery,services,articles,comments,gift'),
	        ...
	        'DETAIL_BLOCKS_ALL_ORDER' => ($arParams['DETAIL_BLOCKS_ALL_ORDER'] ? $arParams['DETAIL_BLOCKS_ALL_ORDER'] : 'complect,kit,sku,buy_services,goods,desc,video,char,reviews,docs,faq,big_gallery,articles,services,buy,payment,delivery,dops,comments,expandables,associated,gift,custom_tab'),
	        ...
	        'GOODS_TEMPLATE' => ($arParams['ELEMENTS_TABLE_TYPE_VIEW'] ? ('FROM_MODULE' == $arParams['ELEMENTS_TABLE_TYPE_VIEW'] ? $arTheme['ELEMENTS_TABLE_TYPE_VIEW']['VALUE'] : $arParams['ELEMENTS_TABLE_TYPE_VIEW']) : 'catalog_linked'),
