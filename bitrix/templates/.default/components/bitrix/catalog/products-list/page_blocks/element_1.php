    ...
    <div class="catalog-detail__item flex-1">
        <?$APPLICATION->IncludeComponent(
            ...
            [
                ...
                'MAX_IMAGE_COUNT' => ($arParams['MAX_IMAGE_COUNT'] ?? '10'),
                'NO_USE_IMAGE' => ($arParams['NO_USE_IMAGE'] ?? 'N'),
                ...
                'T_CATALOG_COMMENTS' => ($arParams['T_CATALOG_COMMENTS'] ? $arParams['T_CATALOG_COMMENTS'] : GetMessage('T_CATALOG_COMMENTS')),
                ...
                'T_BUY_SERVICES' => ($arParams['T_BUY_SERVICES'] ? $arParams['T_BUY_SERVICES'] : GetMessage('T_BUY_SERVICES')),
                ...
                'T_RECOMS' => ($arParams['T_RECOMS'] ? $arParams['T_RECOMS'] : GetMessage('T_RECOMS')),
                ...
                'T_KIT' => ($arParams['T_KIT'] ? $arParams['T_KIT'] : GetMessage('T_KIT')),
                ...
                'LEFT_BLOCK_CATALOG_DETAIL' => $arParams['LEFT_BLOCK_CATALOG_DETAIL'],
                ...
                'CATALOG_SHOW_AMOUNT_STORES' => $arParams['CATALOG_SHOW_AMOUNT_STORES'],
                ...
                'DETAIL_BLOCKS_ORDER' => ($arParams['DETAIL_BLOCKS_ORDER'] ? $arParams['DETAIL_BLOCKS_ORDER'] : 'complect,kit,sku,buy_services,tabs,expandables,associated,big_gallery,services,articles,comments,gift,recoms'),
                'DETAIL_BLOCKS_TAB_ORDER' => ($arParams['DETAIL_BLOCKS_TAB_ORDER'] ? $arParams['DETAIL_BLOCKS_TAB_ORDER'] : 'desc,reviews,char,faq,video,buy,docs,payment,delivery,dops,custom_tab'),
                'DETAIL_BLOCKS_ALL_ORDER' => ($arParams['DETAIL_BLOCKS_ALL_ORDER'] ? $arParams['DETAIL_BLOCKS_ALL_ORDER'] : 'complect,kit,sku,buy_services,goods,desc,video,char,reviews,docs,faq,big_gallery,articles,services,buy,payment,delivery,dops,comments,expandables,associated,gift,recoms,custom_tab'),

                'COUNT_SERVICES_IN_ANNOUNCE' => TSolution::GetFrontParametrValue('SERVICES_COUNT_IN_ANNOUNCE') ?? 2,
                'EXPRESSION_SERVICE_ORDER_BUTTON' => TSolution::GetFrontParametrValue('EXPRESSION_SERVICE_ORDER_BUTTON'),
                'EXPRESSION_SERVICE_ADD_BUTTON' => TSolution::GetFrontParametrValue('EXPRESSION_SERVICE_ADD_BUTTON'),
                ...
                'OFFERS_LIMIT' => $arParams['DETAIL_OFFERS_LIMIT'] ?? $arParams['OFFERS_LIMIT'],

                'TOP_GALLERY_VIEW' => $galleryView,
                ...
                'DISPLAY_VAT_INFO' => TSolution::GetFrontParametrValue('DISPLAY_VAT_INFO'),
