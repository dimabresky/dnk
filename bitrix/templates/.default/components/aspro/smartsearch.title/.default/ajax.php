		...
		<?foreach($arResult["CATEGORIES"] as $category_id => $arCategory):?>
			...
			<tr>
				...
				<?elseif(isset($arItem["ICON"])):?>
					<td class="title-search-item"><a href="<?echo $arItem["URL"]?>"><img src="<?echo $arItem["ICON"]?>"><span class="search-result__item-text"<?=(isset($arItem['RAW_NAME']) ? ' data-raw="'.htmlspecialcharsbx(strip_tags($arItem['RAW_NAME'])).'"' : '')?>><?echo $arItem["NAME"]?></span></a></td>
				<?else:?>
