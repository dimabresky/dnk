...
$inputName = $arOptions['INPUT_NAME'] ?? 'licence';
$isChecked = TSolution::GetFrontParametrValue('LICENCE_CHECKED') === 'Y' || $request->get($inputName) === 'Y';
...
$APPLICATION->IncludeComponent(
    ...
    [
        ...
        'ID' => TSolution::getAgreementIdByOption($arOptions['OPTION_CODE']),
