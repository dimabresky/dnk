...
$inputName = $arOptions['INPUT_NAME'] ?? 'thirdParties';
$isChecked = TSolution::GetFrontParametrValue('THIRD_PARTIES_CHECKED') === 'Y' || $request->get($inputName) === 'Y';
...
$APPLICATION->IncludeComponent(
    ...
    [
        ...
        'BLOCK_NAME' => 'third_parties_block',
