...
$MESS['DNK_HEADER_PROMO_BAR_GROUP_CACHE'] = 'Кеширование';
$MESS['DNK_HEADER_PROMO_BAR_GROUP_VIEW'] = 'Отображение';
$MESS['DNK_HEADER_PROMO_BAR_PARAM_IBLOCK_ID'] = 'ID инфоблока (пусто — из константы DNK_HEADER_PROMO_IBLOCK_ID)';
