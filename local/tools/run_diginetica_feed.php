...
/**
 * Ручной запуск глобального фида Diginetica / AnyQuery.
 * Запуск из корня сайта: php local/tools/run_diginetica_feed.php [output.xml]
 *
 * По умолчанию пишет bitrix/catalog_export/diginetica.xml.
 */
...
$relativeOutput = '/bitrix/catalog_export/diginetica.xml';
...
try {
    $count = DigineticaGlobalFeedExporter::export(
