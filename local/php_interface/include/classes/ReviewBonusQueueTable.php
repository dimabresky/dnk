...
/**
 * ORM для таблицы b_dnk_review_bonus_queue (см. migrations/dnk_review_bonus_queue.sql).
 */
class ReviewBonusQueueTable extends DataManager
{
    ...
    {
        return 'b_dnk_review_bonus_queue';
    }
