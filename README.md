...
3. Настроить константы и интеграции в `local/php_interface/include/constants.php` и окружении под целевой сервер. Для SKU-оттенков в `.env` задайте `DNK_SHADES_IBLOCK_ID` (обычно `47`).
